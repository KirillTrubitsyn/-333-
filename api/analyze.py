...
ПРАВОВАЯ ПОЗИЦИЯ
по вопросу взыскания неустойки с [наименование ответчика]
по делу о [краткое описание спора]
...
ФОРМАТИРОВАНИЕ:
- НЕ используй markdown-разметку (*, **, `, #, - в начале строк)
- ИСКЛЮЧЕНИЕ: используй _«текст»_ для цитат из судебных решений (курсив)
...
- Цитаты оформляй с новой строки в формате: _«цитата»_"""
...
- НЕ используй markdown-разметку (*, **, `, #, - в начале строк)
- ИСКЛЮЧЕНИЕ: используй _«текст»_ для цитат из судебных решений (курсив)
- Для нумерации используй обычные цифры: 1. 2. 3. или 1.1. 1.2.
- Для выделения используй ЗАГЛАВНЫЕ БУКВЫ в заголовках
- Абзацы отделяй пустой строкой
