...
- Пример: Как указал суд в деле А40-12345/2024: _«неустойка в размере 0,1% в день является обычно применяемой в деловом обороте и не может быть признана чрезмерной»_
