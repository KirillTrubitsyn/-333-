...

{
  ...
  "summary": "основные выводы обзора (2-4 предложения)",
  "key_points": ["ключевой вывод 1", "ключевой вывод 2", "ключевой вывод 3"],
  "practical_conclusions": ["практическая рекомендация 1", "практическая рекомендация 2"]
}

Выдели ключевые выводы и практические рекомендации.
Верни ТОЛЬКО JSON без дополнительного текста.
